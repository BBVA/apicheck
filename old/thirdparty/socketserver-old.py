...
def startserver(serversock, loop=False):
    try:
        while 1:
            ...
            try:
                # Remove cache
                # call('find /pyexecnetcache -path ".cache" -delete')
                # call('find /pyexecnetcache -name "*.pyc" -delete')
                # call('find /pyexecnetcache -path "*/__pycache__*" -delete')
                # call('rm -rf /pyexecnetcache/pyexecnetcache')
                call('rm -rf /pyexecnetcache')
...
if __name__ == '__main__':
    ...
    if len(sys.argv)>1:
        ...
        hostport = ":%s" % os.environ.get("PORT")
    else:
        hostport = ':8888'
