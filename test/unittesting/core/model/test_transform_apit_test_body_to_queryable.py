...
from apitest.core.model import transform_apit_test_body_to_queryable, APITestBody
...
def test_transform_apit_test_body_to_queryable_runs_ok_json():
    ...
    assert transform_apit_test_body_to_queryable(data) == {"hello": "world"}
...
def test_transform_apit_test_body_to_queryable_runs_ok_text():
    ...
    assert transform_apit_test_body_to_queryable(data) == "hello=world asdf asd fsadf"
...
def test_transform_apit_test_body_to_queryable_unknown_content_type():
    ...
    assert transform_apit_test_body_to_queryable(data) == "KLASDPIFNPUIEBIUBIUH98"
